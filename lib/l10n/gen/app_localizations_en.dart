...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get reportsAvgPerDay => 'Avg/day';

  @override
  String get reportsDaysActive => 'Days';
  ...
  @override
  String get accountPickerEmpty => 'No accounts available.';

  @override
  String get currencySearchPlaceholder => 'Search code, symbol, or name';

  @override
  String get currencyPickerTitle => 'Select currency';

  @override
  String get currencyNoMatches => 'No matches';
  ...
  @override
  String get chartNoSpendYet => 'No spend yet';
  ...
  @override
  String get proFeatureBudgets => 'Unlimited budgets';
  ...
  String roomMembershipUsageUnlimited(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count rooms · Unlimited',
      one: '1 room · Unlimited',
    );
    return '$_temp0';
  }
  ...
  String roomMembershipUsageLimited(int count, int limit) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count of $limit rooms',
      one: '1 of $limit rooms',
    );
    return '$_temp0';
  }

  @override
  String get roomSlotTitle => 'Add another room';

  @override
  String roomSlotBody(int base, String price) {
    return 'Pro includes $base rooms. Add more for $price each — a one-time purchase, yours to keep.';
  }

  @override
  String roomSlotBuyCta(String price) {
    return 'Buy a room · $price';
  }

  @override
  String get roomSlotBuyShort => 'Buy a room';

  @override
  String get roomSlotSuccess => 'Room added — you can create another room now.';
  ...
  @override
  String get roomsIntroCreateCta => 'Create a room';

  @override
  String get roomsIntroLaterCta => 'Maybe later';
